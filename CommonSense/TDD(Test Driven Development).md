...
![img](https://github.com/Songwonseok/CS-Study/blob/main/CommonSense/images/TDD-1.PNG?raw=true)


하지만 TDD는 기존 방법과는 다르게, 테스트케이스를 먼저 작성한 이후에 실제 코드를 개발하는 리팩토링 절차를 밟는다.

![img](https://github.com/Songwonseok/CS-Study/blob/main/CommonSense/images/TDD-2.PNG?raw=true)
...
![img](https://github.com/Songwonseok/CS-Study/blob/main/CommonSense/images/TDD-3.PNG?raw=true)
