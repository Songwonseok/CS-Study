...
> *`EM`을 클릭했는데도 `DIV`에 할당한 핸들러가 동작합니다.*
...
<iframe class="code-tabs__result" src="https://ko.javascript.info/article/bubbling-and-capturing/bubble-target/" style="display: block; border: 0px; width: 779px; height: 202px;"></iframe>
